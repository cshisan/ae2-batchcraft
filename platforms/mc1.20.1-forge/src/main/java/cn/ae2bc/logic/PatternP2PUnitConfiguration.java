...
public record PatternP2PUnitConfiguration(
    ...
    public PatternP2PUnitConfiguration {
        ...
        redstoneStrength = Numbers.clamp(redstoneStrength, 0, 15);
        pulsePeriodTicks = Numbers.clamp(pulsePeriodTicks, 1, MAX_PULSE_TICKS);
        pulseWidthTicks = Numbers.clamp(pulseWidthTicks, 1, pulsePeriodTicks);

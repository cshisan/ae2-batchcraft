...
class ComponentPlacerSelectionTest {
    ...
    void pointSelectionProducesOneTarget() {
        ...
        assertEquals(new ComponentSelectionGeometry.Position(3, 4, 5), selection.positions(0, 0, 0).get(0));
    }
    ...
    void offsetsTranslateWithoutChangingSelectionSize() {
        ...
        assertEquals(new ComponentSelectionGeometry.Position(6, -3, 4), positions.get(0));

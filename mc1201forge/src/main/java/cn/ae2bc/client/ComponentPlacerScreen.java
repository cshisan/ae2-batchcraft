...
public final class ComponentPlacerScreen extends AEBaseScreen<ComponentPlacerMenu> {
    private final Map<Direction, Button> directionButtons = new EnumMap<>(Direction.class);
    private final Button[] minusButtons = new Button[3];
    private final Button[] plusButtons = new Button[3];
    private final Button resetOffsets;
    ...
    private Button addCompactButton(String widgetId, Component label, Runnable action) {
    ...
    private static final class CompactTextButton extends Button {
        private CompactTextButton(Component label, Button.OnPress onPress) {
            super(0, 0, 0, 0, label, onPress, DEFAULT_NARRATION);
        }
    }

...
class RoundRobinPolicyTest {
    ...
    void wrapsCursorAndOffsetAcrossTheEndpointList() {
        ...
        assertEquals(0, RoundRobinPolicy.index(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE));
        assertEquals(Integer.MAX_VALUE - 2,
                RoundRobinPolicy.index(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE));
    }

...
public final class PatternP2PUnitManagerScreen extends PatternP2PUnitPagedScreen<PatternP2PUnitManagerMenu> {
    ...
    public PatternP2PUnitManagerScreen(PatternP2PUnitManagerMenu menu, Inventory inventory, Component title, ScreenStyle style) {
        ...
        resetTaskToolbar.setMessage(Component.translatable("gui.ae2_batchcraft.reset_task.tooltip.unit"));
    ...
    protected void init() {
        super.init();
        int syncWidth = syncMain.fitToMessage();
        syncMain.setX(leftPos + DashedSectionRenderer.trailingContentX(imageWidth, syncWidth));
    ...
    protected int getPageHeight(Page page) {
        return switch (page) {
            case COMMON -> 146;
            case OUTPUT_COMMON -> 82;
            case UNIT_COMMON -> 82;
            case TRANSFER, BREAK, ENERGY -> 82;
            case REDSTONE -> 166;
        };
    }
    ...
    protected void updateBeforeRender() {
        ...
        energyDistributionMode.active = editable;
    ...
    public void drawBG(GuiGraphics graphics, int offsetX, int offsetY, int mouseX, int mouseY,
        ...
        if (isPage(Page.COMMON)) {
            ...
            drawSectionBackground(graphics, offsetX, offsetY, 85, 137,
                    "gui.ae2_batchcraft.product_extraction.parameters");
